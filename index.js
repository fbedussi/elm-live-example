...
var $author$project$Main$init = {newTodoText: '', todos: _List_Nil};
...
var $author$project$Main$getNextId = function (todos) {
	var lastId = $elm$core$List$maximum(
		A2(
			$elm$core$List$map,
			function (_v1) {
				var id = _v1.a;
	...
	if (lastId.$ === 'Just') {
		var id = lastId.a;
		return $author$project$Main$Id(id + 1);
	} else {
		return $author$project$Main$Id(0);
	}
};
var $author$project$Main$createNewTodo = F2(
	function (text, todos) {
		return {
			done: false,
			id: $author$project$Main$getNextId(todos),
			text: text
		};
	});
var $author$project$Main$toggleTodoDone = F2(
	function (todos, id) {
		return A2(
			$elm$core$List$map,
			function (todo) {
			...
			case 'AddTodo':
				return _Utils_update(
					model,
					{
						...
						todos: A2(
							$elm$core$List$cons,
							A2($author$project$Main$createNewTodo, model.newTodoText, model.todos),
							model.todos)
					});
			default:
				var id = msg.a;
				return _Utils_update(
					model,
					{
						todos: A2($author$project$Main$toggleTodoDone, model.todos, id)
					});
		}
	});
var $author$project$Main$AddTodo = {$: 'AddTodo'};
var $author$project$Main$UpdateNewTodoText = function (a) {
	return {$: 'UpdateNewTodoText', a: a};
};
var $elm$html$Html$Attributes$for = $elm$html$Html$Attributes$stringProperty('htmlFor');
var $elm$html$Html$form = _VirtualDom_node('form');
var $elm$html$Html$label = _VirtualDom_node('label');
var $author$project$Main$ToggleTodoDone = function (a) {
	return {$: 'ToggleTodoDone', a: a};
};
var $author$project$Main$renderTodo = function (todo) {
	return A2(
		$elm$html$Html$li,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						...
						$author$project$Main$ToggleTodoDone(todo.id))
					]),
				_List_fromArray(
					[
						$elm$html$Html$text(
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$for('new-todo-text')
							]),
						_List_Nil),
						A2(
						$elm$html$Html$input,
						_List_fromArray(
							[
								...
								$elm$html$Html$Attributes$id('new-todo-text'),
								$elm$html$Html$Events$onInput($author$project$Main$UpdateNewTodoText),
								$elm$html$Html$Attributes$value(model.newTodoText)
							]),
						_List_Nil),
						A2(
						$elm$html$Html$button,
				...
				$elm$html$Html$ul,
				_List_Nil,
				A2($elm$core$List$map, $author$project$Main$renderTodo, model.todos))
			]));
};
var $author$project$Main$main = $elm$browser$Browser$sandbox(
	{init: $author$project$Main$init, update: $author$project$Main$update, view: $author$project$Main$view});
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{},"unions":{"Main.Msg":{"args":[],"tags":{"UpdateNewTodoText":["String.String"],"AddTodo":[],"ToggleTodoDone":["Main.Id"]}},"Main.Id":{"args":[],"tags":{"Id":["Basics.Int"]}},"String.String":{"args":[],"tags":{"String":[]}},"Basics.Int":{"args":[],"tags":{"Int":[]}}}}})}});
